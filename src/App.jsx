// src/App.jsx — Generated by VIA for: Build a full stack application for a library book management system where users can add books, borrow and return them, track due dates, and view availability — deploy it fully with data saved
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build A Full Stack Application For A Library</span>
            </Link>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build A Full Stack Application For A Library</h1>
