# main.py — Generated by VIA for: Build a full stack application for a library book management system where users can add books, borrow and return them, track due dates, and view availability — deploy it fully with data saved
